 ...
 * @author HAPPY
 */
public class LS_Frame extends javax.swing.JFrame {
    ...
    public void loadDataToTable(JTable table) {
        ...
        try {
            ...
            String sql = "SELECT * FROM log_hocvien";
            ...
            while (rs.next()) {
                ...
                String id_hv = rs.getString("id_hocvien");
                String ten_hv = rs.getString("ten_hocvien");
                String tg = rs.getString("thoi_gian");

                // Thêm dữ liệu vào DefaultTableModel
                model.addRow(new Object[]{id_log, hanhdong, id_hv, ten_hv, tg});
            }
...
//        setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        ls_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Log", "Hành động", "ID học viên", "Tên học viên", "Thời gian"
            }
        ) {
        ...
        jLabel13.setText("LỊCH SỬ CẬP NHẬT HỌC VIÊN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LS_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LS_Frame mainFrame = new LS_Frame();
