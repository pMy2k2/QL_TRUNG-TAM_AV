 ...
 * @author HAPPY
 */
public class LS_KH_Frame1 extends javax.swing.JFrame {
    ...
    public void loadDataToTable(JTable table) {
        ...
        try {
            ...
            // Thực hiện truy vấn để lấy dữ liệu từ bảng "log_khoahoc"
            String sql = "SELECT * FROM log_khoahoc";
            ...
            while (rs.next()) {
                ...
                String tg = rs.getString("log_time");

                // Thêm dữ liệu vào DefaultTableModel
                model.addRow(new Object[]{id_log, action, id_khoa_hoc, ten_khoa_hoc, tg});
            }
...
//        setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        ls_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Log", "Hành động", "ID khoá học", "Tên khoá học", "Thời gian"
            }
        ) {
        ...
        jLabel13.setText("LỊCH SỬ CẬP NHẬT KHOÁ HỌC");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LS_KH_Frame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LS_KH_Frame1 mainFrame = new LS_KH_Frame1();
